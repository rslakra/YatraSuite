package com.rslakra.logistics.yatrasuite.yatrathymeleaf.service.impl;
...
import com.rslakra.logistics.yatrasuite.yatrathymeleaf.config.UserServiceConfig;
 ...
 */
@Service
public class UserServiceImpl extends AbstractClientServiceImpl<User, Long> implements UserService {
     ...
     */
    @Autowired
    public UserServiceImpl(final UserServiceConfig serviceConfig) {
        super(new ApiRestClient(serviceConfig.getRestUrl(null)));
        LOGGER.debug("UserServiceImpl({})", serviceConfig);
    ...
    public List<User> getAll() {
        ...
        try {
            users = Arrays.asList(getRestClient().doGet(USERS, User[].class));
        } catch (Exception ex) {
    ...
    public List<User> getByFilter(Map<String, Object> filters) {
        ...
        final User[] users = getRestClient().doGet(USERS_FILTER, User[].class, filters);
    ...
    public User delete(Long id) {
        ...
        User user = null;
        getRestClient().doDelete(USER_BY_ID, Payload.newBuilder().ofPair("id", id));
