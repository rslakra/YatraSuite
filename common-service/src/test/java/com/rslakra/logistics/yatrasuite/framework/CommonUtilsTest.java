package com.rslakra.logistics.yatrasuite.framework;

import static org.junit.jupiter.api.Assertions.assertEquals;
import static org.junit.jupiter.api.Assertions.assertThrows;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.rslakra.logistics.yatrasuite.common.exception.DeserializationException;
...
//        assertThrows(MicroTestClass.class, () -> CommonUtils.deserialize(mapper, data, MicroTestClass.class));
//    }
    ...
    public void deserialize_shouldReturnTheObject_ifTheObjectIsValid() throws DeserializationException {
        ...
        MicroTestClass result = CommonUtils.deserialize(mapper, data, MicroTestClass.class);
