...
class VehicleControllerTest {
    ...
    private static VehicleIdDTO lastVehicleId;
    ...
    public void removeVehicle_shouldRemoveTheVehicle_ifItExists() throws NotFoundException,
        ...
        String vehicleId = lastVehicleId.getId().toString();
        AbstractResponse abstractResponse = vehicleController.removeVehicle(vehicleId).getBody();
