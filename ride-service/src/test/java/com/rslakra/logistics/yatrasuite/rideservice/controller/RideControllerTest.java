package com.rslakra.logistics.yatrasuite.rideservice.controller;
...
import com.rslakra.logistics.yatrasuite.rideservice.dto.RideResponseDto;
import com.rslakra.logistics.yatrasuite.rideservice.persistence.entity.Ride;
import com.rslakra.logistics.yatrasuite.rideservice.service.RideService;
import com.rslakra.logistics.yatrasuite.rideservice.util.RideTestUtils;
...
class RideControllerTest {
    ...
    public void getActiveRide_shouldReturnTheRide_ifItExists() throws NotFoundException, InvalidUUIDException {
        Ride ride = RideTestUtils.createRide();
    ...
    public void startRide_shouldThrowAnException_ifTheVehicleIdIsInvalid() throws InvalidVehicleStateException {
        RideRequestDto request = RideTestUtils.createRideRequest();
    ...
    public void startRide_shouldStartTheRide() throws InvalidUUIDException, InvalidVehicleStateException {
        Ride ride = RideTestUtils.createRide();
        RideRequestDto request = RideTestUtils.createRideRequest(ride);
    ...
    public void endRide_shouldThrowAnException_ifTheVehicleIdIsInvalid() throws NotFoundException {
        EndRideRequestDto request = RideTestUtils.createEndRideRequest();
        request.setVehicleId("INVALID");
    ...
    public void endRide_shouldEndTheRide_ifItExists()
        ...
        Ride ride = RideTestUtils.createRide();
        EndRideRequestDto request = RideTestUtils.createEndRideRequest(ride);
        LocalDateTime curTime = nextDateTime();
