package com.rslakra.logistics.yatrasuite.userservice.persistence.repository;
...
//    @Query("SELECT u FROM User u WHERE u.status = :status")
    ...
    /**
     * Returns the list of users by <code>emails</code>.
     *
     * @param emails
     * @return
     */
    @Query("SELECT u FROM User u WHERE u.email IN (:emails)")
    public List<User> getByEmails(@Param("emails") List<String> emails);
